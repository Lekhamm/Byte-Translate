...
# Create a new route for summarization
@st.experimental_singleton
def get_summary_button_state():
    return False

@st.experimental_singleton
def set_summary_button_state(value):
    pass

if st.button("Summarize The Text"):
    set_summary_button_state(True)

if get_summary_button_state():
    # Trigger the summarization process here
